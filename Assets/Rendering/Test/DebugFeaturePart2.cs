...
public class DebugFeaturePart2 : ScriptableRendererFeature
{
    [System.Serializable]
    ...
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        const string ProfilerTag = "Debug Pass 2";
        public DebugFeaturePart2.CustomPassSettings settings;
        ...
        public CustomRenderPass(DebugFeaturePart2.CustomPassSettings settings)
        {
            this.settings = settings;
            renderPassEvent = settings.renderPassEvent;

            if (material == null) material = CoreUtils.CreateEngineMaterial("Hidden/DebugShader2");
        }
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            material.SetTexture("_TestTex", settings.test);
